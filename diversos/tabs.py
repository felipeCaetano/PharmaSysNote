...
def main(page: ft.Page):
    ...
    t = ft.Tabs(
        ...
        tabs=[
            ft.Tab(
                text="Tab 1",
                content=ft.Container(content=SearchField(ft.app)),
            ),
            ft.Tab(
    ...
    rail = ft.NavigationRail(
        ...
        leading=ft.FloatingActionButton(icon=ft.icons.LOCAL_PHARMACY, text="PharmaSys"),
        group_alignment=-0.9,
        destinations=[
    ...
    page.add(ft.Row([rail, ft.VerticalDivider(width=1), t], expand=True))
